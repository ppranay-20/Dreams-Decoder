      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildBulletPoint("Personalize your experience and deliver relevant content"),
            _buildBulletPoint("Process and analyze your dreams"),
            _buildBulletPoint("Communicate with you about updates, offers, and features"),
            _buildBulletPoint("Protect the security and integrity of our platform"),
